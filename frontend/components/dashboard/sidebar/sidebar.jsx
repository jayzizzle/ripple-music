  ...
  render() {
    ...
    return (
      <div className='flex-col-start sidebar'>
        ...
        <NavLink className='sidebar-link' to='/dashboard' activeClassName='sidebar-active'>
        ...
        <NavLink className='sidebar-link' to='/playlists' activeClassName='sidebar-active'>
        <div className='sidebar-row'>
        ...
        <NavLink className='sidebar-link' to='/albums' activeClassName='sidebar-active'>
        <div className='sidebar-row'>
          <div className='flex-row-center sidebar-left-col'>
        ...
        <NavLink className='sidebar-link' to='/tracks' activeClassName='sidebar-active'>
        <div className='sidebar-row'>
          <div className='flex-row-center sidebar-left-col'>
        ...
        <NavLink className='sidebar-link' to='/artists' activeClassName='sidebar-active'>
        <div className='sidebar-row'>
          <div className='flex-row-center sidebar-left-col'>
